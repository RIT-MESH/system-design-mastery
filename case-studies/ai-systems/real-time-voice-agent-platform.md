...
sequenceDiagram
  participant C0 as Speech to text
  participant C1 as LLM RAG
  participant C2 as Policy gateway
  participant C3 as Read tools
  participant C4 as Draft high-risk
  C0 ->> C1: send request
