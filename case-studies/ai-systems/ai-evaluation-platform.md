...
sequenceDiagram
  participant P0 as Evaluation run
  participant P1 as Metrics retrieval, gener
  participant P2 as Release
  participant P3 as Block or rollback
  participant P4 as Dashboard
