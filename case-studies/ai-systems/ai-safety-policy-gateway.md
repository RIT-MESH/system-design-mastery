...
sequenceDiagram
  participant P0 as Policy gateway
  participant P1 as Classify risk
  participant P2 as Allow
  participant P3 as Policy-controlled
  participant P4 as Human approval
