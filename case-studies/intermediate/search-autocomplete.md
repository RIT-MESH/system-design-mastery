...
%% created-for: system-design-mastery
sequenceDiagram
  participant P0 as Edge cache - prefix->top
  participant P1 as Suggest service
  participant P2 as Prefix index - in-memory
  participant P3 as Per-user recent terms
  participant P4 as Index builder - stream o
