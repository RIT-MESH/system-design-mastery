...
%% created-for: system-design-mastery
sequenceDiagram
  participant P0 as Rec service
  participant P1 as Retrieval - ann filters
  participant P2 as Ranker - model
  participant P3 as Feature store
  participant P4 as Interactions
