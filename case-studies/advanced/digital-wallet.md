...
%% created-for: system-design-mastery
sequenceDiagram
  participant P0 as Wallet API
  participant P1 as Transfer tx debit credit
  participant P2 as Append-only ledger
  participant P3 as Balance check - no negat
  participant P4 as Bank rails - topup withd
