...
%% created-for: system-design-mastery
sequenceDiagram
  participant P0 as File API
  participant P1 as Metadata DB
  participant P2 as Object storage, versione
  participant P3 as CDN download
  participant P4 as Sync notifications
