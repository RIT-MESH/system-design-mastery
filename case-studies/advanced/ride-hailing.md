...
%% created-for: system-design-mastery
sequenceDiagram
  participant P0 as Matching svc
  participant P1 as Location svc
  participant P2 as Geo index - available dr
  participant P3 as Trip svc
  participant P4 as Live tracking WS
