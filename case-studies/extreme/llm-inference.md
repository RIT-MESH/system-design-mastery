...
Source files under `diagrams/case-studies/llm-inference/`:
`context.mmd` (§11), `completion-sequence.mmd` (§12), `failure-flow.mmd` (§19),
`scaling-evolution.mmd` (§24). Key diagrams embedded inline above.
