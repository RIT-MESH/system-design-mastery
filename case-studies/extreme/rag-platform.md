...
%% created-for: system-design-mastery
sequenceDiagram
  participant C0 as Embed query
  participant C1 as Vector retrieve top-k
  participant C2 as Context citations
  participant C3 as LLM generate
  participant C4 as Grounded answer
  C0 ->> C1: send request
